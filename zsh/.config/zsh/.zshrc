...
# >>> conda initialize >>>
# Disabled - using mamba initialization instead (see lines 92-103)
# The conda init block was conflicting with mamba and causing environment issues
# Use mamba for all conda commands (miniforge3 uses mamba as the preferred tool)
alias conda="mamba"
# <<< conda initialize <<<
