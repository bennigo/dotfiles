...
├── pi/             # Pi Coding Agent — minimal "primitives" alternative — see pi/CLAUDE.md 📄
...
- **Pi**: Minimal terminal coding agent — "primitives, not features" alternative — see `pi/CLAUDE.md`
