---
name: researcher
description: Web research and multi-source synthesis agent. Searches the web, fetches and analyzes content, evaluates sources, and compiles structured research briefs. Large context for handling many sources.
